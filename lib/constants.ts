...
export const properties: Property[] = [
  {
    ...
    country: "Nepal",
    description:
      "Nestled in the majestic Himalayas, our Mountain Retreat & Spa offers breathtaking views and unparalleled luxury. Experience the perfect blend of traditional architecture and modern amenities, complemented by our world-class spa treatments inspired by ancient Himalayan healing practices.",
    shortDescription:
      "Luxury resort with panoramic Himalayan views and traditional spa treatments.",
    imageUrl:
    ...
    roomTypes: [
      {
        ...
        description:
          "Spacious suite with panoramic Himalayan views, private balcony, and luxury amenities.",
        imageUrl:
      ...
      },
      {
        name: "Garden Cottage",
        description:
          "Private cottage surrounded by native gardens with outdoor soaking tub.",
        imageUrl:
  ...
  },
  {
    ...
    country: "Indonesia",
    description:
      "Set along pristine beaches, our Coastal Villas offer privacy and luxury with direct access to turquoise waters. Each villa features traditional Balinese architecture blended with modern design, private pools, and personalized butler service.",
    shortDescription:
      "Exclusive beachfront villas with private pools and personalized service.",
    imageUrl:
    ...
    roomTypes: [
      {
        ...
        description:
          "Spacious villa with direct beach access, private pool, and outdoor living areas.",
        imageUrl:
      ...
      },
      {
        name: "Garden Villa",
        description:
          "Secluded villa surrounded by tropical gardens with private pool and outdoor shower.",
        imageUrl:
  ...
  },
  {
    ...
    country: "Japan",
    description:
      "Located in the heart of Tokyo, Urban Sanctuary offers a peaceful retreat amid the bustling city. The hotel combines Japanese minimalist design with luxurious comfort, featuring a rooftop zen garden, traditional tea ceremony room, and contemporary art throughout.",
    shortDescription:
      "Peaceful luxury hotel with Japanese aesthetic in downtown Tokyo.",
    imageUrl:
    ...
    roomTypes: [
      {
        name: "Zen Suite",
        description:
          "Minimalist luxury suite with city views, tatami area, and modern amenities.",
        imageUrl:
      ...
      },
      {
        name: "Executive Room",
        description:
          "Elegant room with work area, premium bedding, and spa-inspired bathroom.",
        imageUrl:
  ...
  },
  {
    ...
    country: "India",
    description:
      "Our Wellness Retreat in Kerala is dedicated to holistic healing and rejuvenation. Set amidst lush tropical gardens, the retreat offers authentic Ayurvedic treatments, yoga classes, and meditation sessions. The architecture honors local traditions while providing modern comforts.",
    shortDescription:
      "Ayurvedic wellness center with traditional healing practices and yoga.",
    imageUrl:
    ...
    roomTypes: [
      {
        name: "Healing Suite",
        description:
          "Spacious suite with private garden, natural materials, and wellness amenities.",
        imageUrl:
      ...
      },
      {
        name: "Garden Cottage",
        description:
          "Private cottage with traditional design, surrounded by medicinal gardens.",
        imageUrl:
